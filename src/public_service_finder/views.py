    ...
    for service in pending_services:
        if service.pending_update:
            ...
            for key in new_service_dict:
                if (
                    key in old_service_dict
                    and old_service_dict[key] != new_service_dict[key]
                ):
                    changes[key] = {
            ...
            services_with_changes.append({"service": service, "changes": changes})
        else:
            services_with_changes.append({"service": service, "changes": {}})

    # Pass the data to the template
    context = {"services_with_changes": services_with_changes}
