...
urlpatterns = [
    ...
    path("analytics/bookmarks_over_time/", views.bookmarks_over_time, name="bookmarks_over_time"),
    path("analytics/reviews_over_time/", views.reviews_over_time, name="reviews_over_time"),
    path("analytics/average_rating_over_time/", views.average_rating_over_time, name="average_rating_over_time"),
    path("analytics/rating_distribution/", views.rating_distribution, name="rating_distribution"),
