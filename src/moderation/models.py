...
class Flag(models.Model):
    ...
    reason = models.CharField(
        max_length=20, choices=FLAG_REASONS, help_text="Primary reason for flagging"
    )
    ...
    reviewed_at = models.DateTimeField(
        null=True, blank=True, help_text="When an admin reviewed this flag"
    )
    ...
    content_author = models.CharField(
        max_length=255, help_text="Username of the content author"
    )
